...
module.exports = client => {
    ...
    let buttonrow = new Discord.MessageActionRow().addComponents([
        new Discord.MessageButton().setStyle("LINK"server invitectX59yZMv5").setLabel("Support Server"),
        new Discord.MessageButton().setStyle("LINKbot invite8&scope=bot`).setLabel("Invite me")
    ]);
    ...
    client.on("messageCreate", async message => {
        ...
        if( globalChannels.includes(message.channel.id) ){
            ...
            const embed = new Discord.MessageEmbed()
                .setColor("BLURPLE")
                .setAuthor(`${message.author.tag}`, message.member.displayAvatarURL({dynamic: true, size: 256}), "https://discord.gg/ctX59yZMv5")
